...
import DEFAULT.auth.Authentication;
import DEFAULT.auth.HttpBasicAuth;
import DEFAULT.auth.ApiKeyAuth;
import DEFAULT.auth.OAuth;
...
public class ApiClient {
  ...
  private String basePath = "http://DEFAULT";
